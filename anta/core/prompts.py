...
DECIDE = (
    ...
    "('o que anotei sobre X', 'qual era o prazo de Y').\n"
    "- resumir: pedido de resumo do que a pessoa fez num periodo ('resumo de hoje', "
    "'o que fiz essa semana', 'resumo do mes'). Escolha periodo: dia, semana ou mes.\n"
    "- responder: perguntas gerais, conversa, ou o que nao se encaixa acima. E o padrao.\n"
    ...
    "sobre o contrato?')\n"
    "- 'me faz um resumo do que fiz essa semana' -> resumir(periodo='semana')\n"
